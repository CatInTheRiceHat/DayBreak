...
- `assets/qa/color-audit/before/`
- `assets/qa/color-audit/after/`
...
Additional responsive and study-state screenshots are generated by `website/qa/responsive-check.mjs` and `website/qa/study-check.mjs` under `assets/qa/responsive/`.
